...
from tkinter import *
import numpy as np
from bayes_net import bayes_function_ivdag, bayes_function_vdag
...
def get_ai_move(human_move, ai_move, strat):
    '''
    ...
    if strat == "win_stay":
        if human_move == ai_move:
            next_move = ai_move
        elif human_move == 'rock' and ai_move == 'paper':
            next_move = 'paper'
        elif human_move == 'rock' and ai_move == 'scissors':
            next_move = 'paper'
        elif human_move == 'paper' and ai_move == 'rock':
            next_move = 'scissors'
        elif human_move == 'paper' and ai_move == 'scissors':
            next_move = 'scissors'
        elif human_move == 'scissors' and ai_move == 'paper':
            next_move = 'rock'
        elif human_move == 'scissors' and ai_move == 'rock':
            next_move = 'rock'
    else:
        if human_move == ai_move:
            next_move = ai_move
...
def get_bayes_net_human_move(human_move, ai_move, strat):
    if strat =='V_DAG':
        return bayes_function_vdag(human_move, ai_move)
    else:
        return bayes_function_ivdag(human_move, ai_move)
    '''
